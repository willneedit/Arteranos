...
namespace Arteranos.Services
{
    ...
    + "</html>\n";
        ...
        private Dictionary<MultiHash, string> KnownServerDescriptions = new();
        ...
        private void DownloadServerDescription(MultiHash SenderPeerID, string sddPath)
        {
            ...
            async Task DownloadSDAsync(MultiHash SenderPeerID, string sddPath)
            {
                try
                {
                    ...
                    KnownServerDescriptions.Add(SenderPeerID, sddPath);
                }
                catch
                {
            ...
            {
                // Debug.Log($"{sddPath} is already known, skipping description download");
                return;
            }
