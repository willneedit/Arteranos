...
namespace ReadyPlayerMe.AvatarLoader
{
    ...
    /// the scene.
    /// </summary>
    public class AvatarObjectLoader_mod
    {
        private const string TAG = nameof(AvatarObjectLoader_mod);
        ...
        public AvatarObjectLoader_mod(bool useDefaultGLTFDeferAgent = true)
        {
        ...
        public void LoadAvatar(string url, bool reload = false)
        {
        ...
        /// </summary>
        /// <param name="url">The URL to the avatars .glb file.</param>
        private async void Load(string url, bool reload)
        {
            var context = new AvatarContext();
            context.Url = url;
            context.SaveInProjectFolder = SaveInProjectFolder;
            context.AvatarCachingEnabled = avatarCachingEnabled && !reload;
