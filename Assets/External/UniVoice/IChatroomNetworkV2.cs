...
namespace Arteranos.UniVoice
{
    ...
    /// </summary>
    public interface IChatroomNetworkV2 : IDisposable
    {
        // ====================================================================
        #region EVENTS
        // ====================================================================
        ...
        /// </summary>
        event Action<short, ChatroomAudioSegmentV2> OnAudioReceived;

        /// <summary>
        /// Fired when the local user sets audio data to a peer.
        /// </summary>
        event Action<short, ChatroomAudioSegmentV2> OnAudioSent;
        #endregion
        ...
        void SendAudioSegment(short[] peerID, ChatroomAudioSegmentV2 data);
        #endregion
    }
}
